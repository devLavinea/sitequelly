var swiper = new Swiper(".mySwiper", { autoplay: {
    delay: 4000,  // Passa para o próximo slide a cada 4000ms (4 segundos)
    disableOnInteraction: false,  // Não desativa o autoplay quando o usuário interagir
  },
  loop: false,  // Habilita o loop, para que o swiper seja cíclico
});

var swiper2 = new Swiper(".mySwiper2", { autoplay: {
    delay: 4500,  // Passa para o próximo slide a cada 4000ms (4 segundos)
    disableOnInteraction: false,  // Não desativa o autoplay quando o usuário interagir
  },
  loop: false,  // Habilita o loop, para que o swiper seja cíclico
});
